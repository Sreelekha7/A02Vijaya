...
QUnit.test('Testing valid function with several sets of inputs', function (assert) {
    assert.equal(valid(-1), 0, 'Tested with two relatively small positive numbers');
    assert.equal(valid(101), 100, 'Tested with two negative numbers. Any arguments less than 1 will be set to 1.');
    assert.equal(valid(76), 76, 'Tested with two large positive numbers. Any arguments greater than 100 will be set to 100.');
